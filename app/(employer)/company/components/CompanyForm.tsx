...
export interface ICompanyForm extends Omit<Company, 'id' | 'hashedPassword' | 'userId' | 'text' | 'img'> {
  password: string;
  text?: string;
  img?: string;
}
...
export const CompanyForm = ({ setIsOpened }: { setIsOpened: (isOpened: boolean) => void }) => {
  ...
  return (
    <Card color="gray" className="absolute left-[40%] top-1/4 p-8">
